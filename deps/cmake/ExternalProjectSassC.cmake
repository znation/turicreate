ExternalProject_Add(ex_sassc
  ...
  URL ${CMAKE_SOURCE_DIR}/deps/src/sassc-3.6.0/
  INSTALL_DIR ${CMAKE_SOURCE_DIR}/deps/local
  CONFIGURE_COMMAND ""
  BUILD_COMMAND env CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} "CFLAGS=-fPIC ${ARCH_FLAG} ${C_REAL_COMPILER_FLAGS}" PREFIX=${CMAKE_SOURCE_DIR}/deps/local SASS_LIBSASS_PATH=${CMAKE_SOURCE_DIR}/deps/src/libsass-3.6.0/ make -j4 -C ../ex_sassc
