ExternalProject_Add(ex_sassc
  ...
  CONFIGURE_COMMAND ""
  BUILD_COMMAND env CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} "CFLAGS=-fPIC ${ARCH_FLAG} ${C_REAL_COMPILER_FLAGS}" PREFIX=${CMAKE_SOURCE_DIR}/deps/local SASS_LIBSASS_PATH=${CMAKE_SOURCE_DIR}/deps/src/libsass-3.5.5/ make -j4 -C ../ex_sassc
