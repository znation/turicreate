...
class capi_test_visualization {
    ...
    public:
        ...
        void test_1d_plots() {
            ...
            CAPI_CHECK_ERROR(error);
            tc_flexible_type *actual_spec_ft = tc_plot_get_vega_spec(actual_obj, tc_plot_size_default, nullptr, &error);
            CAPI_CHECK_ERROR(error);
            ...
            CAPI_CHECK_ERROR(error);
            actual_spec_ft = tc_plot_get_vega_spec(actual_obj, tc_plot_size_default, nullptr, &error);
            CAPI_CHECK_ERROR(error);
